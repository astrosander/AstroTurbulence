...
def plot_multiple_spectra(
    ...
    for i, spec in enumerate(spectra_list):
        ...
        # Extract η from label and add vertical line at k = η^{2/(m_ψ - m_φ)}
        ...
        if eta_match:
            ...
            if eta > 0:
                ...
                ax.axvline(x=k_vertical, linestyle=":", linewidth=1.0, 
...
def plot_multiple_log_derivatives(
    ...
    for i, spec in enumerate(spectra_list):
        ...
        # Extract η from label and add vertical line at k = π * η^{2/(m_ψ - m_φ)}
        # where m_ψ = -11/3 and m_φ = -2
