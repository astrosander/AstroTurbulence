...
def replot(npz="M_A=2.0, 792^3, t=1.0.npz", meta="M_A=2.0, 792^3, t=1.0.json", out="spectrum_replot.png"):
    data_files = [
        ("M_A=0.8, 256^3.npz", "M_A=0.8, 256^3.json", r"$M_A=0.8, 256^3$", "#2E8B57", 1.0),  # Sea Green
        ("M_A=2.0, 792^3, t=0.5.npz", "M_A=2.0, 792^3, t=0.5.json", r"$M_A=2.0, 792^3, t=0.5$", "#87CEEB", 0.3),  # Sky Blue
        ("M_A=2.0, 792^3, t=1.0.npz", "M_A=2.0, 792^3, t=1.0.json", r"$M_A=2.0, 792^3, t=1.0$", "#4169E1", 0.2),  # Royal Blue
        ("M_A=2.0, 792^3, t=1.1.npz", "M_A=2.0, 792^3, t=1.1.json", r"$M_A=2.0, 792^3, t=1.1$", "#4169E1", 0.4),  # Royal Blue
        ("M_A=2.0, 792^3, t=1.2.npz", "M_A=2.0, 792^3, t=1.2.json", r"$M_A=2.0, 792^3, t=1.2$", "#4169E1", 0.6),  # Royal Blue
        ("M_A=2.0, 792^3, t=1.3.npz", "M_A=2.0, 792^3, t=1.3.json", r"$M_A=2.0, 792^3, t=1.3$", "#4169E1", 0.8,),  # Royal Blue
