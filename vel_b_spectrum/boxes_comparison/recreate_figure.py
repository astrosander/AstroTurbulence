...
def replot(npz="M_A=2.0, 792^3, t=1.0.npz", meta="M_A=2.0, 792^3, t=1.0.json", out="spectrum_replot.png"):
    data_files = [
        ...
        ("M_A=2.0, 792^3, t=1.0.npz", "M_A=2.0, 792^3, t=1.0.json", r"$M_A=2.0, 792^3, t=1.0$", "blue", 0.7),
        ("M_A=2.0, 792^3, t=1.1.npz", "M_A=2.0, 792^3, t=1.1.json", r"$M_A=2.0, 792^3, t=1.1$", "darkblue", 1.0),
