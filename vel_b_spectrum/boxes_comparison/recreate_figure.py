...
def replot(npz="M_A=2.0, 792^3, t=1.0.npz", meta="M_A=2.0, 792^3, t=1.0.json", out="spectrum_replot.png"):
    data_files = [
        ...
        ("M_A=2.0, 792^3, t=1.0.npz", "M_A=2.0, 792^3, t=1.0.json", r"$M_A=2.0, 792^3, t=1.0$", "blue", 0.3),
        ("M_A=2.0, 792^3, t=1.1.npz", "M_A=2.0, 792^3, t=1.1.json", r"$M_A=2.0, 792^3, t=1.1$", "blue", 0.5),
        ("M_A=2.0, 792^3, t=1.2.npz", "M_A=2.0, 792^3, t=1.2.json", r"$M_A=2.0, 792^3, t=1.2$", "darkblue", 1.0),
