...
def replot(npz="M_A=2.0, 792^3, t=1.0.npz", meta="M_A=2.0, 792^3, t=1.0.json", out="spectrum_replot.png"):
    data_files = [
        ...
        ("M_A=2.0, 792^3, t=1.4.npz", "M_A=2.0, 792^3, t=1.4.json", r"$M_A=2.0, 792^3, t=1.4$", "#4169E1", 0.7),  # Royal Blue
        ("M_A=2.0, 792^3, t=1.5.npz", "M_A=2.0, 792^3, t=1.5.json", r"$M_A=2.0, 792^3, t=1.5$", "#4169E1", 1.0),  # Royal Blue
