...
def plot_pfa_results(lambda2, varP, fit_results, output_file="pfa_plot.pdf"):
    ...
    plt.title('PFA/PVA: variance of the polarization across sightlines (Syn)', fontsize=14)
