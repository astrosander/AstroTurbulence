...
def plot_single_point(field, kind, outdir):
    ...
    plt.tight_layout()
    plt.savefig(outdir/f'pdf_single_{kind}.png',dpi=200)
    plt.close()
...
def plot_two_point(field_or_u, Rs, mode, outdir):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(outdir/f'pdf_pairs_{mode}.png',dpi=200)
    plt.close()
    ...
    plt.savefig(outdir/f'structure_{mode}.png',dpi=200); plt.close()
...
def main():
    ...
    (outdir/"pdf_single_azimuth_vec.png").rename(outdir/"pdf_single_vector.png")
    plot_single_point(theta_stokes,"azimuth_stokes",outdir)
    (outdir/"pdf_single_azimuth_stokes.png").rename(outdir/"pdf_single_stokes.png")
